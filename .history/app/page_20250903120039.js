...
export default function Home() {
  ...
  <TopNav />
    ...
    <div className="w-96 border-2  h-36 relative rounded-full overflow-hidden battery" ref={boxRef}>
<div className="w-0 h-full bg-black progress rounded-s-full rounded-tb-full liquid" id="progress" >
